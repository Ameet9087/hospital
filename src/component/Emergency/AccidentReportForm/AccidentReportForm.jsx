...
// //               <div className="AccidentReportForm-radio-button">
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="home" />
// //                   Home
// //                 </label>
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="road" />
// //                   Road
// //                 </label>
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="work" />
// //                   Work
// //                 </label>
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="others" />
// //                   Others
// //                 </label>
// //               </div>
// //             </div>
...
// //               <div className="AccidentReportForm-radio-button">
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="yes" />
// //                   Yes
// //                 </label>
// //                 <label>
// //                   <input type="radio" name="incidentLocation" value="no" />
// //                   No
// //                 </label>
// //               </div>
// //             </div>
...
// //               name="hospitalName"
// //             />
// //             <FloatingInput label="Regn. Number" type="text" name="regnNumber" />
// //           </div>
// //         </div>
// //       </div>
...
const FloatingInput = ({ label, type = "text", value, ...props }) => {
  ...
  return (
    <div className={`AccidentReportForm-floating-field ${(isFocused || hasValue) ? 'active' : ''}`}>
      <input
        type={type}
        className="AccidentReportForm-floating-input"
        value={value}
      ...
      <div className="AccidentReportForm-container">
        ...
        <div className="AccidentReportForm-section">
          ...
          <div className="AccidentReportForm-search-field">
            ...
            <FloatingInput label="Phone No" type="tel" name="phoneNo" />
            <div className="AccidentReportForm-form-group">
              <label value={formData.informedToPolice} onchange={handleChange}>Informed To Police:</label>
              <div className="AccidentReportForm-radio-button">
                <label>
                  <input type="radio" name="survivalToDischarge" value="yes" />
                  Yes
