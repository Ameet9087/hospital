...
onChange={() => handleCheckboxChange('natureOfCall', 'trauma')} />
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Trauma
            </label>
  </div>
...
onChange={() => handleCheckboxChange('natureOfCall', 'interfacility')} />  
          <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Interfacility
            </label>
  </div>
...
onChange={() => handleCheckboxChange('natureOfCall', 'discharge')} />            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Discharge
            </label>
  </div>
  </div>
...
onChange={() => handleCheckboxChange('response', 'transported')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Transported
            </label>
  </div> 
...
onChange={() => handleCheckboxChange('response', 'treatedNoTransfer')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Treated(No Transfer)
            </label>
  </div>
...
onChange={() => handleCheckboxChange('response', 'death')} />             <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Death
            </label>
  </div> 
            </div>
            ...
            <div className="PatientCareReport-row-chechbox-grid">
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.deformities}onChange={() => handleCheckboxChange('injuries', 'deformities')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              D-Deformities
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.contusions}onChange={() => handleCheckboxChange('injuries', 'contusions')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              C-Contusions
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.abrasions}onChange={() => handleCheckboxChange('injuries', 'abrasions')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              A-Abrasions
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.penetrations}onChange={() => handleCheckboxChange('injuries', 'penetrations')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              P-Penetrations
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.burns}onChange={() => handleCheckboxChange('injuries', 'burns')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              B-Burns
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.tenderness}onChange={() => handleCheckboxChange('injuries', 'tenderness')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              T-Tenderness
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.lacerations}onChange={() => handleCheckboxChange('injuries', 'lacerations')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              L-Lacerations
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.injuries.swelling}onChange={() => handleCheckboxChange('injuries', 'swelling')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              S-Sweling
            </label>
  </div> 
            ...
            <div className="PatientCareReport-row-chechbox-grid">
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.circulation.normal}onChange={() => handleCheckboxChange('circulation', 'normal')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Normal
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.circulation.paleCyanosed}onChange={() => handleCheckboxChange('circulation', 'paleCyanosed')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Pale, Cyanosed
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.circulation.absent}onChange={() => handleCheckboxChange('circulation', 'absent')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Absent
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.circulation.chiefComplaints}onChange={() => handleCheckboxChange('circulation', 'chiefComplaints')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Chief Complaints
            </label>
  </div> 
            ...
            <div className="PatientCareReport-row-chechbox-grid">
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.breathing.adequate}onChange={() => handleCheckboxChange('breathing', 'adequate')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Adequate
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.breathing.inadequate}onChange={() => handleCheckboxChange('breathing', 'inadequate')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Inadequate
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.breathing.ab}onChange={() => handleCheckboxChange('breathing', 'ab')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Ab
            </label>
  </div> 
            ...
            <div className="PatientCareReport-row-chechbox-grid">
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.opa}onChange={() => handleCheckboxChange('procedure', 'opa')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              OPA
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.npa}onChange={() => handleCheckboxChange('procedure', 'npa')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              NPA
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.lma}onChange={() => handleCheckboxChange('procedure', 'lma')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              LMA
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.etTube}onChange={() => handleCheckboxChange('procedure', 'etTube')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              ET Tube
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.cricothyroidotomy}onChange={() => handleCheckboxChange('procedure', 'cricothyroidotomy')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Cricothyroidotomy
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.suction}onChange={() => handleCheckboxChange('procedure', 'suction')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Suction
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.oMask}onChange={() => handleCheckboxChange('procedure', 'oMask')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              O Mask
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.ambuBag}onChange={() => handleCheckboxChange('procedure', 'ambuBag')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Ambu Bag
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.ventilator}onChange={() => handleCheckboxChange('procedure', 'ventilator')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Ventilator
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.bleedingControl}onChange={() => handleCheckboxChange('procedure', 'bleedingControl')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Bleeding Control
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.ivCentral}onChange={() => handleCheckboxChange('procedure', 'ivCentral')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              IV Cenytral
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.ivPeripheral}onChange={() => handleCheckboxChange('procedure', 'ivPeripheral')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              IV Peripheral
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.defibrillation}onChange={() => handleCheckboxChange('procedure', 'defibrillation')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Defibrillation
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.cardioversion}onChange={() => handleCheckboxChange('procedure', 'cardioversion')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Cardio Version
            </label>
  </div> 
  ...
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.spineImmobilization}onChange={() => handleCheckboxChange('procedure', 'spineImmobilization')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Spine Immobilization
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.procedure.splinting}onChange={() => handleCheckboxChange('procedure', 'splinting')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Splinting
            </label>
  </div> 
            ...
            <div className="PatientCareReport-row-chechbox-grid">
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.mri.mriChecklist}onChange={() => handleCheckboxChange('mri', 'mriChecklist')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              MRI Checklist
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.mri.tattoos}onChange={() => handleCheckboxChange('mri', 'tattoos')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Any Tattoos on body
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.mri.implants}onChange={() => handleCheckboxChange('mri', 'implants')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Any Implants
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.mri.pcaMaker}onChange={() => handleCheckboxChange('mri', 'pcaMaker')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Any PCA Maker
            </label>
  </div> 
  <div className="PatientCareReport-row-chechbox">
  <input type="checkbox" checked={checkboxes.mri.bodyPiercing}onChange={() => handleCheckboxChange('mri', 'bodyPiercing')} /> 
            <label htmlFor="allowMultiple" className="PatientCareReport-checkbox-label">
              Any Body piercing(Ear Rings Type)
            </label>
  </div> 
