...
const labTests = [
  { appointmentId: "", doctorId: "", patientId: "", patientName: "", appointmentGivenDate:"",status:"", },
...
const DoctorAppointment = () => {
  ...
  return (
    ...
    <div className="doctorAppointment-addBtn">
      <button className="doctorAppointment-add-button" onClick={handleAddNewDoctorAppointment}>+Add New Doctor Appointment</button>
      </div>
      ...
      <div className="doctorAppointment-search-bar">
        ...
        <div className="doctorAppointment-results-info">
          ...
          <button className="doctorAppointment-print-button"><i class="fa-solid fa-file-excel"></i> Export</button>
          <button className="doctorAppointment-print-button"><i class="fa-solid fa-print"></i> Print</button>
        </div>
        </div>
        ...
        <tbody>
          {labTests.map((test, index) => (
            <tr key={index}>
              ...
              <td>
                <button className="doctorAppointment-edit-button"onClick={handleAddNewDoctorAppointment}>Edit</button>
