...
const HospitalSpecialisation = () => {
  ...
  return (
    <div className="HospitalSpecialisation">
      <button className="HospitalSpecialisation__create-btn" onClick={handleAddSpecialisation}>
    ...
    <CustomModal isOpen={showSpecialisations} onClose={()=>setShowSpecialisations(false)}>
