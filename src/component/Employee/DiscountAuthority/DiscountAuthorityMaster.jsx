...
const DiscountAuthorityMaster = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (uploadedFile?.file) {
            ...
            reader.onload = async () => {
                ...
                try {
                    const response = await axios.post(`${API_BASE_URL}/discount-authorities`, payload);
                    alert("Form submitted successfully.");
                } catch (error) {
                    console.error("Error submitting form:", error);
                    alert(error.response?.data || "Error submitting form. Please try again.");
                }
            };
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get(`${API_BASE_URL}/discount-authorities`);
                    ...
                    setFiles([
                        {
                            ...
                            file: data.digitalSignature ? { name: "Digital Signature" } : null,
                        },
                    ]);
                }
            } catch (error) {
            ...
            <div className="DiscountAuthorityMaster-content">
                <div className="DiscountAuthorityMaster-section">
                    ...
                    <div className="AttachDigitalSignature-section">
                        <div className="DiscountAuthorityMaster-Section-header">Attach Digital Signature Here</div>
                        <div className="DiscountAuthorityMaster-data">
