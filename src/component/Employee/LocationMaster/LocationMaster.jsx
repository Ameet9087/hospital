...
function LocationMaster({update,onClose}) {
  ...
  const [locationData, setLocationData] = useState({
    ...
    importNormalRangesFromLocation:update?.importNormalRangesFromLocation|| false,
  ...
  const handleSubmit = async (e) => { 
    ...
    try {
      ...
      onClose();
      alert(update ? "Location updated successfully." : "Location data saved successfully.");
    } catch (error) {
      console.error("Error saving location:", error);
      alert(update ? "unable to saved updated data" : "unable to saved");
    }
  };
            ...
            <div className="location-master__radio-group">
              ...
              <label>
                <input
                  ...
                  name="importNormalRangesFromLocation"
                  value={true}
                  checked={locationData.importNormalRangesFromLocation === true}
                  onChange={handleChange}
                />
                Yes
              </label>
