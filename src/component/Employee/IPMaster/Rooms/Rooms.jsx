  ...
  return (
    ...
    <div className="rooms">
      {/* <div className="rooms-title-bar">
        ...
        <button className='room-add-btn' onClick={openModal}>Add Room Type</button>
          ...
          <div className="rooms-panel rooms-details">
            ...
            <div className="rooms-panel-content">
              ...
              <div className="rooms-form-row">
                <label>Adv Res</label>
                <div className="rooms-input-with-search">
                  <input type="text" value={formdata.advRes} name='advRes' onChange={handleChange}
                    placeholder='Adv Res' />
                </div>
              </div>
              <div className="rooms-form-row">
                <label>Floor</label>
                <div className="rooms-input-with-search">
                  <input type="text" value={selectedFloor?.floorName} onChange={handleChange}
              ...
              <div className="rooms-form-row">
                <label>Paytype</label>
                <div className="rooms-input-with-search">
                  <input type="text" value={selectedPayType?.payTypeName} onChange={handleChange}
                    placeholder='Search Paytype' />
                    <i onClick={()=>setActivePopup("paytype")} className='fa-solid fa-magnifying-glass'></i>
                </div>
              </div>
            </div>
          </div>
