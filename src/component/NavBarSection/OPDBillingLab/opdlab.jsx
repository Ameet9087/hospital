    ...
    <div className="opdlab-billing-container">
      ...
      {currentPatient && (
        <Modal show={showModal} onHide={() => setShowModal(false)}>
          ...
          <Modal.Body>
            <div className="opdlab-billing-modal-body">
              <div className="opdlab-ptninfo">
                <p>
          ...
          <Modal.Footer>
            <button className="opdlab-btn confirm-btn" onClick={confirmPayment}>
              Confirm Payment
            </button>
            <button
              className="opdlab-btn cancel-btn"
