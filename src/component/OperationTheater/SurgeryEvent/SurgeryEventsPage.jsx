...
const postSurgeryDetails = async () => {
  ...
  try {
    ...
    alert("An error occurred while posting surgery details. Please check the console for more details.");
  }
...
const fetchOtMasters = async () => {
  ...
  const fetchAllNurses = async () => {
    try {
      const response = await axios.get(`${ API_BASE_URL }/employees/get-all-nurses`);
      ...
      const nurses = response.data.map((nurse) => ({
        ...
        isActive: nurse.employeeTypeDTO?.isActive === "true" ? "Active" : "Inactive",
      }));
...
// Popup
  ...
  const handleDeleteRow = (tableType, indexToRemove) => {
    if (tableType === 'package') {
      ...
      const updatedRows = servicesTableRows.filter((_, index) => index !== indexToRemove);
      // Renumber the rows
      const renumberedRows = updatedRows.map((row, index) => ({
        ...row,
        sn: index + 1
        ...
        <div className="surgeryEvents-panel-content">
            <div className="surgeryEvents-form-row">
              ...
              <div className="surgeryEvents-form-row">
                ...
                <input type="text" value={booking.operationBookingId} readOnly />
          ...
          <div className="surgeryEvents-panel operation-details">
            ...
            <div className="surgeryEvents-panel-content">
              <div className="surgeryEvents-form-row">
                <label>IP No: *</label>
                <div className="surgeryEvents-input-with-search">
                  <input type="text" value={booking.ipAdmissionDTO?.patient?.inPatientId} />
          ...
          <div className="popup-content">
            ...
            <button className="close-popup-btn" onClick={handleClosePopup}>
              ...
              <div className="surgeryEvents-form-row">
                <label>UHID No: *</label>
                <div className="surgeryEvents-input-with-search">
                  <input type="text" value={booking.ipAdmissionDTO?.patient?.uhid} />
          ...
          <div className="popup-content">
            ...
            <button className="close-popup-btn" onClick={handleClosePopup}>
              ...
              <div className="surgeryEvents-form-row">
                ...
                <input type="text"   value={`${booking.ipAdmissionDTO?.patient?.firstName || ''} ${booking.ipAdmissionDTO?.patient?.lastName || ''}`} 
 />
              </div>
              <div className="surgeryEvents-form-row">
                <label>Age:</label>
                <input type="text" value={booking.ipAdmissionDTO?.patient?.age}  />
              </div>
              <div className="surgeryEvents-form-row">
                <label>Gender:</label>
                <input type="text" value={booking.ipAdmissionDTO?.patient?.gender}/>
              </div>
              <div className="surgeryEvents-form-row">
                ...
                {/* <input type="text" value={booking?.ipAdmissionDTO?.roomDetails?.payTypeDTO?.payTypeName || ''}  /> */}
                    ...
                    <input
                        ...
                        type="text"
                        value={booking.ipAdmissionDTO?.roomDetails?.payTypeDTO?.payTypeName}
                    />
            
              </div>
              <div className="surgeryEvents-form-row">
                <label>Room No:</label>
                <input type="text" value={booking?.ipAdmissionDTO?.roomDetails?.roomDTO?.id || ''} />
              </div>
           
              <div className="surgeryEvents-form-row">
                <label>Referred By:</label>
                <input type="text"  value={booking.ipAdmissionDTO?.admissionUnderDoctorDetail?.consultantDoctor?.doctorName}/>
              </div>
              <div className="surgeryEvents-form-row">
              ...
              <div className="surgeryEvents-form-row">
                ...
                <input type="date" value={booking?.ipAdmissionDTO?.admissionDate} />
              </div>
              <div className="surgeryEvents-form-row">
  ...
  <input
    ...
    value={
      booking?.ipAdmissionDTO?.admissionTime
        ? booking.ipAdmissionDTO.admissionTime.split('.')[0].substr(0, 5)
        : ''
    }
    readOnly
  />
          ...
          <div className="surgeryEvents-panel operation-details">
            ...
            <div className="surgeryEvents-form-row">
              ...
              <div className="surgeryEvents-form-row">
                <label>Ot Time:</label>
                <input type="time"    value={booking?.otTime?.substring(0, 5) || ""} 
                />
              </div>
              {/* <div className="surgeryEvents-form-row">
                <label>To Time:</label>
      ...
      >
        ...
        {operations.map((operation) => (
          <option key={operation.operationMasteId} value={operation.operationMasteId}>
            {operation.operationName} {/* Assuming API provides a `name` field */}
          </option>
        ))}
      </select>
              {/* <div className="surgeryEvents-input-with-search"> */}
