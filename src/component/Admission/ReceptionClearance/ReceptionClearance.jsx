...
const FloatingInput = ({ label, type = "text", value, ...props }) => {
  ...
  return (
    <div
      className={`reception-clearance-floating-field ${
        isFocused || hasValue ? "active" : ""
      }`}
    >
      <input
        type={type}
        className="reception-clearance-floating-input"
        value={value}
        ...
        {...props}
      />
      <label className="reception-clearance-floating-label">{label}</label>
    </div>
  );
};
