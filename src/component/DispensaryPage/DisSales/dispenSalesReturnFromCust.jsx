  ...
  const handleSearch = async (e) => {
    ...
    try {
      ...
      const response = await axios.get(
        `http://localhost:3155/api/patient-invoices/${invoiceNo}`
      );
  ...
  var subtot;
    ...
    try {
      ...
      if (response.status === 200 || response.status === 201) {
        ...
        // Update invoiceData to only include returned medicines
        // setInvoiceData((prevData) => ({
        //   ...prevData,
        //   medicines: returnedMedicines,
        //   total_amt: returnedMedicines.reduce(
        //     (total, med) => total + med.subTotal,
        //     0
        //   ),
        // }));
