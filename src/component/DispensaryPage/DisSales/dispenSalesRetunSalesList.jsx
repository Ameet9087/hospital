...
function DispenSalesRetunSalesList() {
  ...
  useEffect(() => {
    ...
    axios.get('http://localhost:3155/api/hospital/return-lists/fetch-all-returnList')
      .then(response => {
  ...
  const handleViewInvoiceClick = (id) => {
    ...
    axios.get(`http://localhost:3155/api/hospital/return-lists/fetch-specific-data/${id}`)
      .then(response => {
