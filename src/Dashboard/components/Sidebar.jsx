  ...
  return (
    <div className={`custom-sidebar ${isOpen ? '' : 'custom-sidebar-closed'}`}>
      ...
      <ul className="custom-sidebar-links">
        ...
        <li
          className={`custom-nav-item ${
            activeLink === "userManagement-submenu1" ||
            activeLink === "userManagement-submenu2" || 
            activeLink === "userManagement-submenu3" 
         
              ? "custom-nav-item-active"
              : ""
          }`}
        >
          <div className="custom-nav-link-content" onClick={handleUserManagmentClick}>
            <span>
              <TbUsers />
            </span>
            {isOpen && <span className="custom-nav-link-text">User Management</span>}
            <span className="custom-dropdown-icon">
              {openMenus.userManagement ? <LuChevronUp /> : <LuChevronDown />}
            </span>
          </div>
          {openMenus.userManagement && isOpen && (
            <ul className="custom-submenu">
              <li
                onClick={() => handleItemClick("UserManagement", "submenu1")}
                className={
                  activeLink === "userManagement-submenu1" ? "custom-submenu-active" : ""
                }
              >
                <Link to="/role">Role</Link>
              </li>
              <li
                onClick={() => handleItemClick("UserManagement", "submenu2")}
                className={
                  activeLink === "userManagement-submenu2" ? "custom-submenu-active" : ""
                }
              >
                <Link
              ...
              <li
                onClick={() => handleItemClick("UserManagement", "submenu2")}
                className={
                  activeLink === "userManagement-submenu3" ? "custom-submenu-active" : ""
                }
              >
                <Link
                  to="/user"
