...
const Sidebar = ({
  ...
  const handleOphthalmology=()=>{
    handleLinkClick("ophthalmology");
    onOphthalmology();
  }
...
>
<div className="custom-nav-link-content" onClick={handleOphthalmology}>
  <span>
    <TbUsers />
  </span>
  {isOpen && <span className="custom-nav-link-text">Ophthalmology</span>}
  <span className="custom-dropdown-icon">
    {openMenus.ophthalmology ? <LuChevronUp /> : <LuChevronDown />}
  </span>
</div>
{openMenus.ophthalmology && isOpen && (
  <ul className="custom-submenu">
    <li
      onClick={() => handleItemClick("ophthalmology", "submenu1")}
      className={
        activeLink === "doctor-submenu1"
          ? "custom-submenu-active"
          : ""
    ...
    >
      <Link to="/ortho-outpatient">Out Patient</Link>
    </li>
    <li
      onClick={() => handleItemClick("ophthalmology", "submenu2")}
      className={
        activeLink === "doctor-submenu2"
          ? "custom-submenu-active"
          : ""
    ...
    >
      <Link to="/ortho-inpatient">In Patient Department </Link>
    </li>
  </ul>
)}
</li>
